...
public class CommonGoal_6 extends CommonGoal{
     ...
     *If after going through the whole row, the size of the array is five, then I update the counter.
     *At the end the check is done to see if the counter has a value less than or equal to two.
