...
public class PersonalGoal_12 extends PersonalGoal{
    ...
    public void initializeGoalGrid() {
        ...
        spotGrid[5][0].placeTile(new Tile(Color.GREEN, 0));
        ...
        spotGrid[3][3].placeTile(new Tile(Color.AZURE,0));
        spotGrid[3][3].setOccupied(true);
        spotGrid[0][2].placeTile(new Tile(Color.WHITE,0));
