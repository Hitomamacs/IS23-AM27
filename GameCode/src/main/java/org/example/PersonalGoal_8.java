...
public class PersonalGoal_8 extends PersonalGoal{
    ...
    public void initializeGoalGrid() {
        ...
        spotGrid[1][1].placeTile(new Tile(Color.GREEN, 0));
        spotGrid[1][1].setOccupied(true);
        spotGrid[0][4].placeTile(new Tile(Color.BLUE, 0));
        spotGrid[0][4].setOccupied(true);
        spotGrid[5][3].placeTile(new Tile(Color.YELLOW,0));
        spotGrid[5][3].setOccupied(true);
        spotGrid[2][2].placeTile(new Tile(Color.AZURE,0));
        spotGrid[2][2].setOccupied(true);
        spotGrid[4][3].placeTile(new Tile(Color.WHITE,0));
        spotGrid[4][3].setOccupied(true);
        spotGrid[3][0].placeTile(new Tile(Color.PINK, 0));
