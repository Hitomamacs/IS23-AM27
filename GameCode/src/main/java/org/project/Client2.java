...
public class Client2 implements ClientInterface, Runnable {
    private final ClientView clientView = new ClientView();
    private BufferedReader in;
    private PrintWriter out;
    private final String hostName = "127.0.0.1";
    private final int portNumber = 5678;
    ...
    // Similarly create createQuitMessage, createPickMessage and createTopUpMessage ...
    ...
    public static void main(String[] args) {
        SocketClientApp client = new SocketClientApp();
