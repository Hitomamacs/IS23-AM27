...
import org.project.Controller.Server.RMIServerApp;
...
public class ClientProva extends UnicastRemoteObject implements RMIClientInterface {
 /**
  * reference to the server object
  */
 private RMIServerInterface rmiServer;
   public ClientProva() throws RemoteException{}

    public static void main (String ergs[]) throws Exception{
       ClientProva client= new ClientProva();
       client.startClient();
